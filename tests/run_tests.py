...
for a in [
    ...
    "COLL_STAGING_MAGAZIJNLIJST","COLL_STAGING_PROJECTENLIJST","COLL_STAGING_FOTOLIJST",
    ...
    "AIRFLOW_INPUT_PROJECTEN","AIRFLOW_INPUT_IMAGES","AIRFLOW_INPUT_PROJECTENLIJST",
    "AIRFLOW_INPUT_MAGAZIJNLIJST","AIRFLOW_INPUT_FOTOLIJST","AIRFLOW_INPUT_MONSTER",
    "AIRFLOW_INPUT_RAPPORTEN","AIRFLOW_OUTPUT_MEDIA","AIRFLOW_CORRECTIES_CONFIG",
...
mc.AIRFLOW_WASSTRAAT_CONFIG = os.path.join(
    PROJECT_ROOT, "data", "test", "wasstraat_config", "Wasstraat_Config_HarmonizeV3.xlsx"
)
