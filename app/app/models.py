...
class Spoor(Model):
    ...
    key = Column(String(40))
    key_spoor = Column(String(40))
    key_vlak = Column(String(40))
    key_put = Column(String(40))
    projectID = Column(ForeignKey('Def_Project.primary_key'), index=True)
    project = relationship('Project')
...
class Foto(Model):
    ...
    key = Column(String(40))
    key_artefact = Column(String(40))
    key_project = Column(String(40))
    key_project_type = Column(String(40))
    key_vondst = Column(String(40))
...
class Plaatsing(Model):
    ...
    herkomst_0 = Column('herkomst.0', Text)
    inhoud = Column(Text)
    key_doos = Column(Text)
    key_magazijnlocatie = Column(Text)
    projectcd = Column(String(12))
    projectnaam = Column(Text)
    stelling = Column(Text)
    table = Column(String(40))
